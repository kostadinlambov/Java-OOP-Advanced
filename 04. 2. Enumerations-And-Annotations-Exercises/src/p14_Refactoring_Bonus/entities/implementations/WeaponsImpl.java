package p14_Refactoring_Bonus.entities.implementations;

import p14_Refactoring_Bonus.entities.enumerations.Gems;
import p14_Refactoring_Bonus.entities.enumerations.WeaponType;
import p14_Refactoring_Bonus.entities.interfaces.MyAnnotation;
import p14_Refactoring_Bonus.entities.interfaces.Weapon;

@MyAnnotation(author = "Pesho",revision = "3", description = "Used for Java OOP Advanced course - Enumerations and Annotations.", reviewers = {"Pesho","Svetlio"})
